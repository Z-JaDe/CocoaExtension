...
public extension CGFloat {
    ...
    static func scaleValue(beginValue: CGFloat, endValue: CGFloat, percentComplete: CGFloat) -> CGFloat {
...
public extension CGFloat {
     ...
     */
    func flat(scale: CGFloat = 0) -> Self {
     ...
     */
    func floorInPixel(scale: CGFloat = 0) -> Self {
        let scale: CGFloat = scale > 0 ? scale : UIScreen.main.scale
