...
public extension SCNPlane {
    ...
    /// Creates a square plane geometry with the specified width.
    ///
    ...
    /// Creates a plane geometry with the specified width, height and material.
    ///
    /// - Parameters:
    ...
    /// Creates a square plane geometry with the specified width and material.
    ///
    /// - Parameters:
    ...
    /// Creates a plane geometry with the specified width, height and material color.
    ///
    /// - Parameters:
    ///   - width: The width of the plane along the x-axis of its local coordinate space.
    ///   - height: The height of the plane along the y-axis of its local coordinate space.
    ...
    /// Creates a square plane geometry with the specified width and material color.
    ///
    /// - Parameters:
    ///   - width: The width and height of the plane along the x-axis and y-axis of its local coordinate space.
    ///   - color: The color of the geometry's material.
