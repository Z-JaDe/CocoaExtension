...
public extension SCNBox {
    ...
    /// Creates a box geometry with the specified width, height, and length.
    ///
    /// - Parameters:
    ...
    /// Creates a cube geometry with the specified side length, and chamfer radius.
    ///
    /// - Parameters:
    ...
    /// Creates a box geometry with the specified width, height, length, chamfer radius, and material.
    ///
    /// - Parameters:
    ///   - width: The width of the box along the x-axis of its local coordinate space.
    ///   - height: The height of the box along the y-axis of its local coordinate space.
    ...
    /// Creates a cube geometry with the specified side length, chamfer radius, and material.
    ///
    /// - Parameters:
    ///   - sideLength: The width, height, and length of the box in its local coordinate space.
    ///   - chamferRadius: The radius of curvature for the edges and corners of the box.
    ...
    /// Creates a box geometry with the specified width, height, length, chamfer radius, and material color.
    ///
    /// - Parameters:
    ///   - width: The width of the box along the x-axis of its local coordinate space.
    ///   - height: The height of the box along the y-axis of its local coordinate space.
    ...
    /// Creates a cube geometry with the specified side length, chamfer radius, and material color.
    ///
    /// - Parameters:
    ///   - sideLength: The width, height, and length of the box in its local coordinate space.
    ///   - chamferRadius: The radius of curvature for the edges and corners of the box.
