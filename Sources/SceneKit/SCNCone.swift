...
public extension SCNCone {
    ...
    /// Creates a cone geometry with the given top diameter, bottom diameter, and height.
    ///
    /// - Parameters:
    ...
    /// Creates a cone geometry with the given top radius, bottom radius, height, and material.
    ///
    /// - Parameters:
    ...
    /// Creates a cone geometry with the given top diameter, bottom diameter, height, and material.
    ///
    /// - Parameters:
    ///   - topDiameter: The diameter of the cone’s top, forming a circle in the x- and z-axis dimensions of its local coordinate space.
    ///   - bottomDiameter: The diameter of the cone’s base, forming a circle in the x- and z-axis dimensions of its local coordinate space.
