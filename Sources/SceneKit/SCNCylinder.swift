...
public extension SCNCylinder {
    ...
    /// Creates a cylinder geometry with the specified diameter and height.
    ///
    /// - Parameters:
    ...
    /// Creates a cylinder geometry with the specified radius, height and material.
    ///
    /// - Parameters:
    ///   - radius: The radius of the cylinder’s circular cross section in the x- and z-axis dimensions of its local coordinate space.
    ///   - height: The height of the cylinder along the y-axis of its local coordinate space.
    ...
    /// Creates a cylinder geometry with the specified diameter, height and material.
    ///
    /// - Parameters:
    ///   - radius: The radius of the cylinder’s circular cross section in the x- and z-axis dimensions of its local coordinate space.
    ///   - height: The height of the cylinder along the y-axis of its local coordinate space.
    ...
    /// Creates a cylinder geometry with the specified radius, height, and material color.
    ///
    /// - Parameters:
    ///   - radius: The radius of the cylinder’s circular cross section in the x- and z-axis dimensions of its local coordinate space.
    ///   - height: The height of the cylinder along the y-axis of its local coordinate space.
    ...
    /// Creates a cylinder geometry with the specified diameter, height, and material color.
    ///
    /// - Parameters:
